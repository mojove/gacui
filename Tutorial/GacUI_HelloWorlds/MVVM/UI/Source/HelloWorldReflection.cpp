...
#define _ ,
			BEGIN_CLASS_MEMBER(::helloworld::MainWindow)
				...
				CLASS_MEMBER_METHOD(buttonText_Clicked, { L"sender" _ L"arguments" })
			...
			BEGIN_CLASS_MEMBER(::helloworld::MainWindowConstructor)
				...
				CLASS_MEMBER_FIELD(buttonText)
				CLASS_MEMBER_FIELD(htTrackerText)
				CLASS_MEMBER_FIELD(progressText)
